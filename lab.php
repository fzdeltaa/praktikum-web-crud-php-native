...
<body class="index">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <p class="nav-link active" aria-current="page" href="lab.php">Lab</p>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container text-center">
        <div class="row">
                ...
                <table class="table">
                    ...
                    ?>
                        <tr>
                            <td><?= $data['id_lab']; ?></td>
                            <td><?= $data['lab']; ?></td>
                            <td><a href=hapus_lab.php?id_lab=<?php echo $data['id_lab']; ?>><button type="button" class="btn btn-dark btn-outline-danger">Delete</button></a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
            ...
            <div class="col ms-5 me-5 pt-5 ps-5 pe-5">
                <h1>Input Data Lab</h1>
                <hr>
                <h6>Masukkan Ruangan Lab yang Tersedia</h6>
                <form method="POST" action="lab_proses.php">

                    <div class="pt-5">
                        <input class="form-control text-light bg-transparent text-align-center" type="text" name="lab" placeholder="Input Nama Lab">
